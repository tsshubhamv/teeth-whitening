...
class BlendingnetModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument(
                "--lr_G", type=float, default=0.0001, help="initial learning rate for adam generator"
            )
            parser.add_argument(
                "--lr_D", type=float, default=0.0004, help="initial learning rate for adam discriminator"
            )
